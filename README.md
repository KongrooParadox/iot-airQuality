...
### Application AirQuality finale

```
[{"id":"94264842.82948","type":"tab","label":"Application AirQuality","disabled":false,"info":"# Affichage LCD de la qualité de l'air au CERI\n\nOn va afficher les différentes variables qui nous intéressent :\n- Température (°C)\n- Humidité (%H)\n- Taux de CO2 (ppm)\n- TVOC (ppb)"},{"id":"f5250958.2e206","type":"inject","z":"94264842.82948","name":"Envoi tous les 15 minutes","topic":"","payload":"","payloadType":"date","repeat":"600","crontab":"","once":false,"onceDelay":"","x":180,"y":60,"wires":[["dc1427a8.d7f208"]]},{"id":"27e514f5.6172a4","type":"ui_gauge","z":"94264842.82948","name":"","group":"221bd7f5.c256f8","order":1,"width":"6","height":"6","gtype":"wave","title":"Température","label":"°C","format":"{{value}}","min":0,"max":"40","colors":["#00b500","#e6e600","#ca3838"],"seg1":"","seg2":"","x":850,"y":260,"wires":[]},{"id":"9e8a20a0.2be21","type":"ui_gauge","z":"94264842.82948","name":"","group":"221bd7f5.c256f8","order":2,"width":"6","height":"6","gtype":"donut","title":"Humidité","label":"%","format":"{{value}}","min":0,"max":"100","colors":["#00b500","#e6e600","#ca3838"],"seg1":"","seg2":"","x":840,"y":300,"wires":[]},{"id":"fd7e7c73.6cfc5","type":"ui_gauge","z":"94264842.82948","name":"","group":"2b42bd1.ae1afc2","order":1,"width":"6","height":"6","gtype":"gage","title":"CO2","label":"ppm","format":"{{value}}","min":0,"max":"2000","colors":["#00b500","#e6e600","#ca3838"],"seg1":"","seg2":"","x":830,"y":380,"wires":[]},{"id":"d06d58a.1246728","type":"ui_gauge","z":"94264842.82948","name":"","group":"2b42bd1.ae1afc2","order":2,"width":"6","height":"6","gtype":"donut","title":"TVOC","label":"ppb","format":"{{value}}","min":"125","max":"1000","colors":["#00b500","#e6e600","#ca3838"],"seg1":"","seg2":"","x":830,"y":340,"wires":[]},{"id":"dc1427a8.d7f208","type":"pythonshell in","z":"94264842.82948","name":"Script Capteur","pyfile":"/home/pi/iot-airQuality/sensor.py","virtualenv":"","continuous":false,"stdInData":false,"x":220,"y":200,"wires":[["f7c97e06.9096d","fd27a2e6.7dbcd8","40b8eaec.cfa86c","2e5533d3.3630b4"]]},{"id":"f7c97e06.9096d","type":"function","z":"94264842.82948","name":"prepareDataForTTN","func":"var m = msg.payload.split(';');\nif(m.length !== 1) { // On n'envoie pas de message si tableau de données est vide\n    var humidite = parseFloat(m[0]);\n    var temperature = parseFloat(m[1]);\n    var tvoc = parseFloat(m[2]);\n    var co2 = parseFloat(m[3]);\n    \n    var o = {payload : \n        {temperature : temperature, \n        humidite : humidite,\n        tvoc : tvoc,\n        co2 : co2}\n        };\n    return o;\n}","outputs":1,"noerr":0,"x":540,"y":160,"wires":[["d2facdc2.1e5118","db737111.a833a"]]},{"id":"d2facdc2.1e5118","type":"debug","z":"94264842.82948","name":"TTN_output","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","x":830,"y":60,"wires":[]},{"id":"db737111.a833a","type":"ttn downlink","z":"94264842.82948","name":"TTN","app":"28deb04e.9e89d8","dev_id":"temp-hum-sensor-4","port":"","confirmed":false,"schedule":"replace","x":810,"y":100,"wires":[]},{"id":"2e5533d3.3630b4","type":"function","z":"94264842.82948","name":"prepareDataForLCD","func":"var m = msg.payload.split(';');\nif(m.length !== 1) { // On n'envoie pas de message si notre tableau de données est vide\n    var humidite = parseFloat(m[0]);\n    var temperature = parseFloat(m[1]);\n    var tvoc = parseFloat(m[2]);\n    var co2 = parseFloat(m[3]);\n    \n    var o1 = {payload : temperature};\n    var o2 = {payload : humidite};\n    var o3 = {payload : tvoc};\n    var o4 = {payload : co2};\n    if ((temperature !== null) && (humidite !== null) && (humidite !== null) && (co2 !== null))\n    return [o1, o2, o3, o4];\n}","outputs":4,"noerr":0,"x":540,"y":260,"wires":[["27e514f5.6172a4"],["9e8a20a0.2be21"],["d06d58a.1246728"],["fd7e7c73.6cfc5"]]},{"id":"fd27a2e6.7dbcd8","type":"debug","z":"94264842.82948","name":"python_output","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","x":520,"y":120,"wires":[]},{"id":"313e28d4.0f213","type":"influxdb out","z":"94264842.82948","influxdb":"cc0befc.a3aca9","name":"InfluxDB","measurement":"mesures","precision":"","retentionPolicy":"","x":840,"y":200,"wires":[]},{"id":"40b8eaec.cfa86c","type":"function","z":"94264842.82948","name":"prepareDataForDB","func":"var m = msg.payload.split(';');\nif(m.length !== 1) { // On n'envoie pas de message si notre tableau de données est vide\n    var humidite = parseFloat(m[0]);\n    var temperature = parseFloat(m[1]);\n    var tvoc = parseFloat(m[2]);\n    var co2 = parseFloat(m[3]);\n    msg.payload = [{\n        \"temperature\": temperature,\n        \"humidite\":humidite,\n\t\t\"co2\":co2,\n\t\t\"tvoc\":tvoc\n        }];\n    return msg;\n}","outputs":1,"noerr":0,"x":530,"y":200,"wires":[["313e28d4.0f213","d7586362.b58158"]]},{"id":"d7586362.b58158","type":"debug","z":"94264842.82948","name":"DB_output","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"payload","x":850,"y":160,"wires":[]},{"id":"83f53036.1184d","type":"pythonshell in","z":"94264842.82948","name":"Script Capteur","pyfile":"/home/pi/iot-airQuality/sensor.py","virtualenv":"","continuous":false,"stdInData":false,"x":220,"y":260,"wires":[["2e5533d3.3630b4"]]},{"id":"589cd8db.0947f8","type":"inject","z":"94264842.82948","name":"On demand","topic":"","payload":"","payloadType":"date","repeat":"","crontab":"","once":false,"onceDelay":0.1,"x":130,"y":360,"wires":[["83f53036.1184d"]]},{"id":"221bd7f5.c256f8","type":"ui_group","z":"","name":"Gauche","tab":"94e021cc.cb63a8","disp":false,"width":"6","collapse":false},{"id":"2b42bd1.ae1afc2","type":"ui_group","z":"","name":"Droite","tab":"94e021cc.cb63a8","disp":false,"width":"6","collapse":false},{"id":"28deb04e.9e89d8","type":"ttn app","z":"","appId":"tp2-temp-hum","accessKey":"ttn-account-v2.dp_bYW19zX7W3Rq_QH5kF8LDRNkdKdVl2JGJYbgBtqk","discovery":"discovery.thethingsnetwork.org:1900"},{"id":"cc0befc.a3aca9","type":"influxdb","z":"","hostname":"127.0.0.1","port":"8086","protocol":"http","database":"iot","name":"Mesures Capteurs","usetls":false,"tls":""},{"id":"94e021cc.cb63a8","type":"ui_tab","z":"","name":"Qualité de l'air au CERI","icon":"dashboard"}]
```
